...
from Policies.Compaction import MetaCompaction
import time
import os
...
if __name__ == "__main__":
    ...
    meta_compact = MetaCompaction(N=n, K=k)
    ...
    for i in range(15):
        ...
        if flag:
            ...
            fallback_expert, experts = meta_compact.compact(experts, fallback_expert, buffer)
            time.sleep(5)
        else:
