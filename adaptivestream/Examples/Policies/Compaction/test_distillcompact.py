...
from Policies.Compaction import DistillCompaction
import time
import os
...
if __name__ == "__main__":
    ...
    distill_compact = DistillCompaction(N=n, K=k, temperature=temp, alpha=alpha)
    ...
    for i in range(15):
        ...
        if flag:
            ...
            fallback_expert, experts = distill_compact.compact(experts, fallback_expert, buffer)
            time.sleep(5)
        else:
