...
from Policies.Compaction import AdaptationCompaction
import time
import os
...
if __name__ == "__main__":
    ...
    adapt_compact = AdaptationCompaction(N=n, K=k, strategy=strategies)
    ...
    for i in range(15):
        ...
        if flag:
            ...
            fallback_expert, experts = adapt_compact.compact(experts, fallback_expert, buffer)
            time.sleep(5)
        else:
